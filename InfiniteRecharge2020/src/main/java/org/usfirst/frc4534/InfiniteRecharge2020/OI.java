...
public class OI {
    ...
    public OI() {
        ...
        leftJoystick = new JoystickButton(joystick1, 9);
        ...
        SmartDashboard.putNumber("Left Encoder", Robot.driveTrain.GetLeftEncoders());
        SmartDashboard.putNumber("Right Encoder", Robot.driveTrain.GetRightEncoders());
