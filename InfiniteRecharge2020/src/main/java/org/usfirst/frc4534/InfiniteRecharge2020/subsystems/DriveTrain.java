...
public class DriveTrain extends Subsystem {
    ...
    //Encoder Offsets
    double rightEncodersOffset = 0;
    double LeftEncodersOffset = 0;
    ...
    public void ZeroEncoders() {
        rightEncodersOffset = GetRightEncodersTotal();
        LeftEncodersOffset = GetLeftEncodersTotal();
    }
    ...
    public double GetRightEncodersTotal() {
